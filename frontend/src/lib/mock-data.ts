...
export const kpiCards = [
  { title: 'Total Candidates', value: 128, delta: '+12%', tone: 'text-violet-300' },
...
export const recentCandidates = [
  { name: 'Alex Thompson', role: 'Frontend Developer', score: 92, status: 'Qualified', source: 'Email', received: '2 min ago' },
  { name: 'Priya Sharma', role: 'Backend Engineer', score: 87, status: 'Qualified', source: 'Website', received: '15 min ago' },
  { name: 'John Doe', role: 'Full Stack Developer', score: 65, status: 'Needs Info', source: 'Email', received: '1 hr ago' },
  { name: 'Maria Garcia', role: 'UI/UX Designer', score: 78, status: 'Qualified', source: 'LinkedIn', received: '2 hrs ago' },
]
